...
public class HttpParams {
    ...
    // 读取超时10m
    public static int READ_TIME_OUT = 600000;
    // 写入超时10m
    public static int WRITE_TIME_OUT = 600000;
    // 缓存路径, 默认路径为: /data/data/packageName/cache/HttpCache
    public static String CACHE_FILE_NAME = "HttpCache";
    // 缓存大小: 20MB
    public static int CACHE_SIZE = 1024 * 1024 * 20;
    // Http Content-Type
